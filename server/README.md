...
(`acme/payments-api`, PR #482, the built-in agents, and the L02 starter skills
linked to Test Quality Reviewer).

## Review context (non-obvious)

What the reviewer actually sends to the model — Repo Intel gating, the
prompt-injection defense, the grounding gate — is covered in
[`server/docs/review-context.md`](docs/review-context.md).
